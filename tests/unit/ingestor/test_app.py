...
class TestCoinbaseIngester:
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    async def test_process_message_subscriptions(self, mock_broker_class, mock_load_config, ingestor_config):
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    async def test_process_message_ticker(self, mock_broker_class, mock_load_config, ingestor_config, sample_coinbase_ticker):
        ...
        with patch.object(ingester, '_process_ticker', new_callable=AsyncMock) as mock_process:
            await ingester._process_message(message)
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    async def test_process_message_heartbeat(self, mock_broker_class, mock_load_config, ingestor_config):
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    async def test_process_message_unknown_type(self, mock_broker_class, mock_load_config, ingestor_config):
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    async def test_process_message_invalid_json(self, mock_broker_class, mock_load_config, ingestor_config):
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    async def test_process_ticker_success(self, mock_broker_class, mock_load_config, ingestor_config, sample_coinbase_ticker):
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    async def test_process_ticker_publish_error(self, mock_broker_class, mock_load_config, ingestor_config, sample_coinbase_ticker):
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    async def test_process_ticker_transform_error(self, mock_broker_class, mock_load_config, ingestor_config):
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    async def test_process_ticker_stats_printing(self, mock_broker_class, mock_load_config, ingestor_config, sample_coinbase_ticker):
    ...
    async def test_stop(self, mock_broker_class, mock_load_config, ingestor_config):
        ...
        with patch.object(ingester, '_stop_health_server', new_callable=AsyncMock) as mock_stop:
            await ingester.stop()
...
class TestCoinbaseIngesterHealthEndpoints:
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    def test_health_endpoint(self, mock_broker_class, mock_load_config, ingestor_config):
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    def test_ready_endpoint_not_ready(self, mock_broker_class, mock_load_config, ingestor_config):
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    def test_ready_endpoint_ready(self, mock_broker_class, mock_load_config, ingestor_config):
    ...
    def test_metrics_endpoint(self, mock_get_metrics, mock_broker_class, mock_load_config, ingestor_config):
...
class TestCoinbaseIngesterStartStop:
    ...
    @patch('services.ingestor.app.load_nats_config')
    @patch('services.ingestor.app.NATSStreamManager')
    async def test_start_connects_broker(self, mock_broker_class, mock_load_config, ingestor_config):
