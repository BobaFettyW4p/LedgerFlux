...
async def run_load_test(gateway_url: str, products: List[str], num_clients: int = 5, duration: int = 60):
...
def parse_args():
    ...
    parser.add_argument('--gateway-url', type=str, default='ws://localhost:8000/ws',
